...
import frc.robot.subsystems.shooter.Shooter.StatusGoal;
...
public class Intake extends SubsystemBase {
    ...
    private final LoggedTunableNumber intakekD = new LoggedTunableNumber("Intake/intake/kP",
            IntakeConsts.INTAKE_CONFIGS.kD);
    private final LoggedTunableNumber intakekS = new LoggedTunableNumber("Intake/intake/kP",
            IntakeConsts.INTAKE_CONFIGS.kS);
    private final LoggedTunableNumber intakekV = new LoggedTunableNumber("Intake/intake/kP",
            IntakeConsts.INTAKE_CONFIGS.kV);

    private final LoggedTunableNumber deploykP = new LoggedTunableNumber("Intake/intake/kP",
            IntakeConsts.INTAKE_CONFIGS.kP);
    private final LoggedTunableNumber deploykD = new LoggedTunableNumber("Intake/intake/kP",
            IntakeConsts.INTAKE_CONFIGS.kD);
    private final LoggedTunableNumber deploykS = new LoggedTunableNumber("Intake/intake/kP",
            IntakeConsts.INTAKE_CONFIGS.kS);
    private final LoggedTunableNumber deploykV = new LoggedTunableNumber("Intake/intake/kP",
            IntakeConsts.INTAKE_CONFIGS.kV);

    private final LoggedTunableNumber tuningIntakeSpeed = new LoggedTunableNumber("Intake/Tuning/Intake", 0.0);

    private final LoggedTunableNumber tuningDeployPosition = new LoggedTunableNumber("Intake/Tuning/DeployPosition",
            0.0);
        ...
        runOnce(() -> {
            ...
            switch (goal) {
                ...
                case OFF:
                    ...
                    break;
                case RETRACTED:
                    rectractDeploy(Degrees.of(IntakeConstants.intakeDeploy.TARGET_POSITION_DEGREES_RETRACT));
                    break;
                default:
                    stop();
                    break;
