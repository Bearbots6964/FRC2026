...
public class IntakeIOTalonFX implements IntakeIO {
    ...
    private final Follower followRequest = new Follower(
            ...
            IntakeConsts.INTAKE_MOTOR_OUTPUT_CONFIGS.Inverted == IntakeConsts.INTAKE_MOTOR_OUTPUT_CONFIGS2.Inverted
    ...
    public IntakeIOTalonFX() {
        ...
        leadConfiguration = new TalonFXConfiguration()
        ...
        deployConfiguration = new TalonFXConfiguration()
    ...
    public void updateInputs(IntakeIOInputs inputs) {
        inputs.intakeConnected = BaseStatusSignal.refreshAll(intakeSpeed, intakeVolts, intakeAmps, intakeAccel).isOK();
        ...
        inputs.intakeDeployConnected = BaseStatusSignal
                .refreshAll(deploySpeed, deployVolts, deployAmps, deployAccel, deployPos).isOK();
