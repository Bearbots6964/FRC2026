...
public class IntakeConstants {
    public static final class IntakeConsts {
        ...
        public static final Slot0Configs INTAKE_CONFIGS = new Slot0Configs()
                .withKP(0.0)
                .withKD(0.0)
                .withKS(0.0)
                .withKV(0.0);
        ...
        public static final MotorOutputConfigs INTAKE_MOTOR_OUTPUT_CONFIGS2 = new MotorOutputConfigs()
    ...
    public static final class intakeDeploy {
        ...
        public static final Slot0Configs INTAKE_DEPLOY_SLOT0_CONFIGS = new Slot0Configs()
                .withKP(0.0)
                .withKD(0.0)
                .withKS(0.0)
                .withKV(0.0);
        public static final CurrentLimitsConfigs INTAKE_DEPLOY_CURRENT_LIMITS_CONFIGS = new CurrentLimitsConfigs()
                .withStatorCurrentLimit(30.0);

        public static final MotorOutputConfigs INTAKE_DEPLOY_OUTPUT_CONFIGS = new MotorOutputConfigs()
